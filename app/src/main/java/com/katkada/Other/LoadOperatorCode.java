 ...
 */
public class LoadOperatorCode extends AsyncTask {
    JSONParser jsonParser = new JSONParser();
    public static String OperatorNumber, OperatorKey;
    @Override
    ...
    protected JSONObject doInBackground(Object[] args) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(Config.GET_OPERATOR_KEY_URL, "GET", params);
        return json;
    }
    @Override
    protected void onPostExecute(Object o) {
        ...
        if (o != null) {
            ...
            try {
                ...
                OperatorKey = String.valueOf(jobject);
