        ...
        if (!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") &&
            ...
            Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("prakash.techzar@gmail.com", "prakash.techzar1!");
                }
            });
...
// send email
            ...
            try {
                t.connect("smtp.gmail.com", "prakash.techzar@gmail.com", "prakash.techzar1!");
                t.sendMessage(msg, msg.getAllRecipients());
            } catch (Exception e) {
                Log.d("Transport", "Error: " + e);
            }
            return true;
        } else {
            return false;
