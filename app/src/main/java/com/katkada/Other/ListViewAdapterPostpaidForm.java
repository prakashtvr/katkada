...
public class ListViewAdapterPostpaidForm extends BaseAdapter {
    Activity context;
    String title[];
    String description[];
    String title1[];
    ...
    String plantypeID[];
    String plan;
    public ListViewAdapterPostpaidForm(Activity context, String[] title, String[] description, String[] title1, String[] description1, String plantype, String[] plantypeID) {
        super();
